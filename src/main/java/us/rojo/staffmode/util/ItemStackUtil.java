...
public class ItemStackUtil {
    ...
    static {
        ...
        FIRE_RESISTANCE_POTION = new ItemStack(Material.POTION, 1, (short) 8227);
        POISON_POTION = new ItemStack(Material.POTION, 1, (short) 8196);
        HEALING_POTION = new ItemStack(Material.POTION, 1, (short) 8261);
        NIGHT_VISION_POTION = new ItemStack(Material.POTION, 1, (short) 8230);
        WEAKNESS_POTION = new ItemStack(Material.POTION, 1, (short) 8232);
        STRENGTH_POTION = new ItemStack(Material.POTION, 1, (short) 8201);
        LEAPING_POTION = new ItemStack(Material.POTION, 1, (short) 8202);
        SLOWNESS_POTION = new ItemStack(Material.POTION, 1, (short) 8234);
        HARMING_POTION = new ItemStack(Material.POTION, 1, (short) 8268);
        WATER_BREATHING_POTION = new ItemStack(Material.POTION, 1, (short) 8237);
        INVISIBILITY_POTION = new ItemStack(Material.POTION, 1, (short) 8238);
    ...
    static {
        ...
        HEALING_SPLASH = new ItemStack(Material.POTION, 1, (short) 16453);
